...
func TestCrossPlatformCoverageExemptGeneratedFiles(t *testing.T) {
	changed := map[string][]lineRange{
		...
		"internal/cli/code.go":                          {{Start: 1, End: 5}},
	}
	filtered, exempted := exemptGeneratedFiles(changed, func(path string) bool {
		return path == "internal/cli/schemacachepb/schema_cache.pb.go"
	})
	...
	if !reflect.DeepEqual(exempted, []string{"internal/cli/schemacachepb/schema_cache.pb.go"}) {
		t.Fatalf("exempted = %v, want sorted exempted paths", exempted)
	}
}
...
func TestCrossPlatformCoverageFileIsGenerated(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "protoc-gen-go marker before package clause",
			path: write("schema_cache.pb.go", "// Code generated by protoc-gen-go. DO NOT EDIT.\n// versions:\n// \tprotoc-gen-go v1.33.0\n\npackage schemacachepb\n"),
			want: true,
		},
		{
			name: "marker after package clause is not generated",
			path: write("late.go", "package cli\n\n// Code generated by protoc-gen-go. DO NOT EDIT.\n\nfunc f() {}\n"),
			want: false,
		},
		{
			name: "hand-written file is not generated",
			path: write("code.go", "package cli\n\nfunc f() int { return 1 }\n"),
			want: false,
		},
		{
			name: "missing file is not generated",
			path: filepath.Join(dir, "nonexistent.go"),
			want: false,
		},
		{
			name: "unparsable file is not generated",
			path: write("broken.go", "package cli\n\nfunc {{{\n"),
			want: false,
		},
	}
	for _, tc := range cases {
		if got := fileIsGenerated(tc.path); got != tc.want {
			t.Errorf("%s: fileIsGenerated() = %v, want %v", tc.name, got, tc.want)
		}
	}
}
...
func TestCrossPlatformCoverageRunLogsExemptedGeneratedFiles(t *testing.T) {
	dir := t.TempDir()
	generated := filepath.Join(dir, "schema_cache.pb.go")
	if err := os.WriteFile(generated, []byte("// Code generated by protoc-gen-go. DO NOT EDIT.\npackage pb\n\nfunc Keep() { println(\"generated\") }\n"), 0o600); err != nil {
		t.Fatal(err)
	}
	profile := filepath.Join(dir, "coverage.out")
	body := "mode: atomic\nexample.com/project/internal/a.go:10.1,12.2 5 1\n"
	...
	if !strings.Contains(stderr.String(), "exempting "+generated+" (generated code)") {
		t.Fatalf("stderr = %q, want generated-code exemption log", stderr.String())
	}
}
